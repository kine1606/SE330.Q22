                ...
                <div className="glass" style={{ borderRadius: '1rem', overflow: 'hidden' }}>
                    {cartItems.map((item, index) => (
                        ...
                        >
                            ...
                            {/* Cột 3: Bộ tăng giảm số lượng (Bọc trong một khung cố định width để căn giữa) */}
                            ...
                            {/* Cột 4: Tổng tiền của sản phẩm đó (Cố định width trùng với cột giá lẻ để cân đối) */}
                            <div style={{ fontSize: '1.25rem', fontWeight: '700', width: '200px', textAlign: 'right' }}>
